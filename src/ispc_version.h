...
#define OLDEST_SUPPORTED_LLVM ISPC_LLVM_15_0
#define LATEST_SUPPORTED_LLVM ISPC_LLVM_20_0
...
#error "Only LLVM 15.0 - 19.1 and 20.0 development branch are supported"
#endif
