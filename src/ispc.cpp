...
class AllCPUs {
  ...
  public:
    AllCPUs() {
        ...
        compat[GPU_LNL_A0] = Set(GPU_LNL_A0, GPU_LNL_A1, GPU_LNL_B0, GPU_MTL_U, GPU_MTL_H, GPU_ACM_G10, GPU_ACM_G11,
                                 GPU_ACM_G12, GPU_TGLLP, GPU_SKL, CPU_None);
        compat[GPU_LNL_A1] = Set(GPU_LNL_A0, GPU_LNL_A1, GPU_LNL_B0, GPU_MTL_U, GPU_MTL_H, GPU_ACM_G10, GPU_ACM_G11,
                                 GPU_ACM_G12, GPU_TGLLP, GPU_SKL, CPU_None);
        compat[GPU_LNL_B0] = Set(GPU_LNL_A0, GPU_LNL_A1, GPU_LNL_B0, GPU_MTL_U, GPU_MTL_H, GPU_ACM_G10, GPU_ACM_G11,
                                 GPU_ACM_G12, GPU_TGLLP, GPU_SKL, CPU_None);
#endif
    }
