...
static ISPCTarget lGetSystemISA() {
    ...
    case Target::ISA::NVL_AVX10_2:
        // Return DMR/SPR target for LLVM versions < 22.0
        // TODO: NVL is DMR without AMX so if ISPC supports AMX natively, this should be revisited.
#if ISPC_LLVM_VERSION >= ISPC_LLVM_22_0
        return ISPCTarget::avx10_2nvl_x8;
#elif ISPC_LLVM_VERSION >= ISPC_LLVM_20_0
    ...
    AllCPUs() {
        ...
        compat[CPU_NVL] =
            Set(CPU_NVL, CPU_x86_64, CPU_Bonnell, CPU_Penryn, CPU_Core2, CPU_Nehalem, CPU_Silvermont, CPU_SandyBridge,
                CPU_IvyBridge, CPU_Haswell, CPU_Broadwell, CPU_Skylake, CPU_ADL, CPU_ARL, CPU_LNL, CPU_GNR, CPU_DMR, CPU_None);
#endif
        compat[CPU_TGL] =
