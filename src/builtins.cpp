...
std::unordered_map<ISPCTarget, ISPCTarget> targetParentMap = {
    ...
    // Note that sse41* targets are aliases for sse4 and avx1_i32x4 is alias for sse4_i32x4,
    // so these targets are not present in this map.
    {ISPCTarget::avx2vnni_i32x4, ISPCTarget::avx2_i32x4},
    {ISPCTarget::avx2_i32x4, ISPCTarget::sse4_i32x4},
    ...
    {ISPCTarget::sse4_i16x8, ISPCTarget::generic_i16x8},
