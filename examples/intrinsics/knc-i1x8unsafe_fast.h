 ...
 *
 *  Using test compiler: Intel(r) SPMD Program Compiler (ispc), 1.4.5dev (build commit d68dbbc7bce74803 @ 20130919,
 * LLVM 3.3) Using C/C++ compiler: icpc (ICC) 14.0.0 20130728
 *
 */
