...
Sgemm
====
This program uses ISPC to implement a few toy versions of matrix multiply
to explore syntax and implementation options enabled by ISPC. Most of the
optimized examples are able to achieve 85-90% peak architectural flops using
AVX2 compilation target, yet retain elegantly simple code to understand and
maintain.

For the foundational example of optimized code, see the ISPC kernel
SGEMM_tileNoSIMDIntrin().
