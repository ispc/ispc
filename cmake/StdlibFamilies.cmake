...
function(generate_stdlib_target_map_cpp)
    ...
    file(WRITE ${output_file}
        ...
        "inline std::unordered_map<ISPCTarget, ISPCTarget> createStdlibTargetMap() {\n"
        "    std::unordered_map<ISPCTarget, ISPCTarget> map;\n"
        "\n"
    )
    ...
    foreach(family ${STDLIB_FAMILIES})
        ...
        foreach(target ${STDLIB_FAMILY_${family}})
            ...
            file(APPEND ${output_file}
                "    map[ISPCTarget::${target_enum}] = ISPCTarget::${generic_enum};\n"
            )
        endforeach()
