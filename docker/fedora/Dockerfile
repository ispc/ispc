...
RUN dnf install -y vim wget yum-utils gcc gcc-c++ git subversion python m4 bison flex patch make ncurses-devel zlib-devel glibc-devel.x86_64 glibc-devel.i686 && \
    dnf clean -y all
