...
define <16 x double> @__shuffle_double(<16 x double> %input, <16 x i32> %perm) {
    ...
    %low = shufflevector <16 x double> %input, <16 x double> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
    %high = shufflevector <16 x double> %input, <16 x double> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>

    ; Get first 8 indices and convert to i64
    %perm_low = shufflevector <16 x i32> %perm, <16 x i32> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
    %indices1 = zext <8 x i32> %perm_low to <8 x i64>

    ; Get second 8 indices and convert to i64
    %perm_high = shufflevector <16 x i32> %perm, <16 x i32> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
    ...
    ; Concatenate results
    %final = shufflevector <8 x double> %result1, <8 x double> %result2, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
...
define <16 x i64> @__shuffle_i64(<16 x i64> %input, <16 x i32> %perm) {
    ; Split input into two 512-bit halves
    %low = shufflevector <16 x i64> %input, <16 x i64> undef, <8 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7>
    %high = shufflevector <16 x i64> %input, <16 x i64> undef, <8 x i32> <i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
    ...
    ; Concatenate results
    %final = shufflevector <8 x i64> %result1, <8 x i64> %result2, <16 x i32> <i32 0, i32 1, i32 2, i32 3, i32 4, i32 5, i32 6, i32 7, i32 8, i32 9, i32 10, i32 11, i32 12, i32 13, i32 14, i32 15>
    ret <16 x i64> %final
}
