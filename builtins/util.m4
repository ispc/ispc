...
;; $1: vector element type
;; $2-$3: 2 input 32-wide vectors
;; $4: output 64-wide vector
define(`v32tov64', `
  $4 = shufflevector <32 x $1> $2, <32 x $1> $3,
...
define float @__stdlib_cbrtf(float) nounwind readnone alwaysinline {
  %r = call float @cbrtf(float %0)
  ret float %r
}
